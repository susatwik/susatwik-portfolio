...
const DotGrid = ({
  ...
  }, [mounted, proximity, baseColor, activeRgb, baseRgb, circlePath]);
    ...
    const onMove = (e: MouseEvent) => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._isAnimating) {
          ...
          const pushX = (dot.cx - pr.x) * (speed / 1000) * 0.5;
          const pushY = (dot.cy - pr.y) * (speed / 1000) * 0.5;
