...
const projects = [
    ...
    },
    {
        ...
        hoverColor: "group-hover:from-blue-600/40 group-hover:to-indigo-500/20",
        span: "md:col-span-2",
        mediaType: "image",
    ...
    },
    {
        ...
        hoverColor: "group-hover:from-purple-600/40 group-hover:to-violet-500/20",
        span: "md:col-span-2",
        mediaType: "image",
    ...
    },
    {
        ...
        hoverColor: "group-hover:from-green-600/40 group-hover:to-lime-500/20",
        span: "md:col-span-1",
        mediaType: "image",
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row h-full">
                            ...
                            <div className="w-full md:w-2/5 min-h-[300px] relative overflow-hidden flex flex-col justify-end p-8">
                                <img
                                    src={project.demoUrl || project.mediaUrl}
                                    alt={project.title}
                                    className="absolute inset-0 w-full h-full object-cover opacity-80"
                                />
                                <div className={`absolute inset-0 bg-linear-to-b ${project.color} mix-blend-overlay opacity-80`} />
                            ...
                            <div className="w-full md:w-3/5 p-8 md:p-12 bg-[#121212]">
                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
                                    ...
                                    <p className="text-gray-300 leading-relaxed mb-8 text-lg">{project.longDescription}</p>
                                    <div className="mb-10">
...
export default function Projects() {
    ...
    // Scroll lock when modal is open – restores exact scroll position on close
    useEffect(() => {
        if (selectedId) {
            ...
            const scrollY = top ? parseInt(top.replace('-', ''), 10) : 0;
            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
                        A curated selection of projects demonstrating full-stack capabilities, microservices architecture, and modern interface design.
                    </p>
                    {mounted && isMobile ? (
                        <div className="relative" style={{ perspective: '1000px' }}>
                            {projects.map((project, index) => (
                                <ProjectCard key={project.id} project={project} index={index} isMobile={true} onSelect={handleSelect} />
                            ))}
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(280px,auto)] grid-flow-dense">
                            <AnimatePresence mode="popLayout">
                                {projects.map((project, index) => (
                                    <ProjectCard key={project.id} project={project} index={index} isMobile={false} onSelect={handleSelect} />
                                ))}
                            </AnimatePresence>
                        </div>
                    )}
