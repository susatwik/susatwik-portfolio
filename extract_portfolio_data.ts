...
function extractPersonalInfo(): any {
...
function extractContactInfo(): any {
...
function extractSocialLinks(): any {
...
function extractExperiences(): any {
...
function extractOtherSections(): any {
  return {
    certifications: [],
    achievements: [],
    leadership: [],
